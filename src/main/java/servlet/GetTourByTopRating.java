 ...
 * @author DELL
 */
public class GetTourByTopRating extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Sort tours by average star rating in descending order
            tours.sort(new Comparator<Tour>() {
                @Override
                public int compare(Tour tour1, Tour tour2) {
                    return Integer.compare(tour2.getAverageStar(), tour1.getAverageStar());
                }
            });
