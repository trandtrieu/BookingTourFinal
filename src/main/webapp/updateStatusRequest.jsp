            ...
            <div class="row tm-content-row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 tm-block-col">
                    <div class="tm-bg-primary-dark tm-block tm-block-products">
                        ...
                        <form action="UpdateStatusRequest" method="post">
                            <div class="row tm-edit-product-row">
                                <div class="col-xl-12 col-lg-12 col-md-12">
                                    <div class="form-group mb-3 col-xs-12 col-sm-6">
                                        <label for="id">Status
                                        </label>
                                        <input value="${detail.requestId}" id="id" name="id" type="text" class="form-control validate"      />

                                    </div>
                                    <div class="form-group mb-3 col-xs-12 col-sm-6">
                                        <label for="status">Status
                                        </label>
                                        <input value="${detail.status}" id="status" name="status" type="text" class="form-control validate" />
