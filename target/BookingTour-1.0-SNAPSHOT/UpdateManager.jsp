                            ...
                            <div class="row tm-edit-product-row">
                                <div class="col-xl-6 col-lg-6 col-md-12">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input value="${tt.tourId}" id="id" name="id" type="text" class="form-control validate bg-secondary" readonly />
                                    </div>
                                    <div class="form-group mb-3">
...
<!--                                        <input value="${tt.detailTour}" id="details" name="details" type="text" class="form-control validate" />-->
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input  value="${tt.imageTour}" id="image" name="image" type="file" class="form-control validate bg-secondary-50"  />
